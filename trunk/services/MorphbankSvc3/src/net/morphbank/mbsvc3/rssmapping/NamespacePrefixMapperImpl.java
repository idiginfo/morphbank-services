...
class NamespacePrefixMapperImpl extends NamespacePrefixMapper {
	...
	public String getPreferredPrefix(String namespaceUri, String suggestion,
		...
		if (ObjectFactory.MRSS_NAMESPACE.equals(namespaceUri)) return "media";
		if (ObjectFactory.GEO_NAMESPACE.equals(namespaceUri)) return "geo";
		if (ObjectFactory.GEORSS_NAMESPACE.equals(namespaceUri))
			return "georss";
	...
	public String[] getPreDeclaredNamespaceUris() {
		return new String[]{ObjectFactory.GEO_NAMESPACE,
				ObjectFactory.GEORSS_NAMESPACE, ObjectFactory.MRSS_NAMESPACE};
	}
}
