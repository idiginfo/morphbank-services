...
public class RestfulPost {
	...
	// static String UPLOAD_FILE = "C:/dev/morphbank/baskauf/morphbanknew.xml";
	static String UPLOAD_FILE = "C:/dev/morphbank/specifyimport/mb.May4.xml";
	// static String UPLOAD_FILE =
	...
	public static void main(String[] args) throws Exception {
		RestfulPost postXML = new RestfulPost();
