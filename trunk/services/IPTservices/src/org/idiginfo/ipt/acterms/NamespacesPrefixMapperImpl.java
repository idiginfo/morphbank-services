...
class NamespacesPrefixMapperImpl extends NamespacePrefixMapper {
	...
	public String getPreferredPrefix(String namespaceUri, String suggestion,
		...
		String ns = Namespaces.PREFIX_MAP.get(namespaceUri);
		if (ns != null)
			return ns;
	...
	public String[] getPreDeclaredNamespaceUris() {
		return new String[] {};
		// Collection<String> nsValues = Namespaces.NS_MAP.values();
		// String[] values = new String[nsValues.size()];
		// nsValues.toArray(values);
		// return values;
