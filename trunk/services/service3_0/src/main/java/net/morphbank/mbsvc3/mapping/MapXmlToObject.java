...
public class MapXmlToObject {
	...
	protected Dictionary<XmlBaseObject, XmlBaseObject> responseObjects = new Hashtable<XmlBaseObject, XmlBaseObject>();
	...
	public BaseObject createObject(XmlBaseObject xmlObject, String objectType, XmlId xmlId)
		...
		if (object != null) {
			...
			XmlBaseObject responseObj = responseMapper.createResponseObject(xmlObject, object);
			setResponseObject(xmlObject, responseObj);
	...
	public BaseObject createOrUpdateObject(IdObject existingObject, XmlBaseObject xmlObject,
		...
		if (idObject == null){
			...
			setResponseObject(xmlObject, responseObject);
		}
		if (!(idObject instanceof BaseObject)) {
			// handle Taxon
			return null;
		...
		if (object != null) {
			...
			setRelatedObject(xmlObject, object);
			reportSuccess(xmlObject, object);
			setResponseObject(xmlObject, responseMapper.createResponseObject(xmlObject, object));
			xmlObject.setMorphbankId(object.getId());
		}
	...
	public void setResponseObject(XmlBaseObject xmlObj, XmlBaseObject obj) {
		if (obj == null) return;
		responseObjects.put(xmlObj, obj);
	}
	public XmlBaseObject getResponseObject(XmlBaseObject xmlObj) {
		return responseObjects.get(xmlObj);
	}
