...
public class RdfImage extends RdfBaseObject implements RdfMetadata {
	...
	public void addBasicProperties(Resource res) {
		...
		RdfOntologies.addProperty(res, RdfOntologies
				.mbankProperty("imageHeight"), image.getImageHeight());
		RdfOntologies.addProperty(res, RdfOntologies
				.mbankProperty("imageWidth"), image.getImageWidth());
		RdfOntologies.addProperty(res, RdfOntologies
				.mbankProperty("resolution"), image.getResolution());
		RdfOntologies.addProperty(res, RdfOntologies
				.mbankProperty("magnification"), image.getMagnification());
		RdfOntologies.addProperty(res,
				RdfOntologies.mbankProperty("imageType"), image.getImageType());
		RdfOntologies.addProperty(res,
				RdfOntologies.mbankProperty("photographer"), image.getAccessNum());
		RdfOntologies.addProperty(res, RdfOntologies
				.dublinProperty("rights"), image.getCopyrightText());
		RdfOntologies.addProperty(res, RdfOntologies
				.dublinProperty("license"), image.getCreativeCommons());
	}
