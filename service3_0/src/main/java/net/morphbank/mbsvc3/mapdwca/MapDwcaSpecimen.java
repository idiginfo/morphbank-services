...
public class MapDwcaSpecimen {

	FieldMapper specimen;
	static ObjectFactory objectFactory = new ObjectFactory();
	private String[][] userProperties = null;

	public MapDwcaSpecimen(FieldMapper specimen) {
		this.specimen = specimen;
		this.userProperties = this.getUserProperties();
	}

	// TODO change all fieldNames to match the core/extension fields
	public void setXmlSpecimenFields(XmlBaseObject xmlSpecimen) {
		...
		xmlSpecimen.addDarwinTag(objectFactory
				.createOtherCatalogNumbers(specimen
						.getValue("Previous Catalog Number")));
		xmlSpecimen.addDarwinTag(objectFactory
				.createRelatedCatalogedItems(specimen
		...
		xmlSpecimen.addDarwinTag(objectFactory.createLocality(specimen
				.getValue("Locality")));
		xmlSpecimen.addDarwinTag(objectFactory
				.createInformationWithheld(specimen
						.getValue("Information Withheld")));
		xmlSpecimen
				.addDarwinTag(objectFactory
						.createDecimalLatitude(getDouble(specimen
								.getValue("Latitude"))));
		xmlSpecimen.addDarwinTag(objectFactory
				.createDecimalLongitude(getDouble(specimen
						.getValue("Longitude"))));
		...
		xmlSpecimen.addDarwinTag(objectFactory
				.createMinimumDepthInMeters(getDouble(specimen
						.getValue("Minimum Depth"))));
		xmlSpecimen.addDarwinTag(objectFactory
				.createMaximumDepthInMeters(getDouble(specimen
						.getValue("Maximum Depth"))));
		xmlSpecimen.addUserProperty("Institution",
				specimen.getValue("Institution Name"));
		xmlSpecimen.addUserProperty("LocalityDescription",
				specimen.getValue("Locality Description"));
