...
@XmlType(name = "object", propOrder = { "sourceId", "status", "owner", "dateCreated",
		"dateLastModified", "dateToPublish", "objectTypeId",
		"name",
		"description",
		"submittedBy",
		"objectLogo",
		...
		// image
		"image", "height", "width", "resolution", "magnification",
		"imageType",
		"copyrightText",
		"originalFileName",
		"creativeCommons",
		...
		"eol",
		// publication
		"publicationType", "annote", "author", "publicationTitle", "chapter", "edition", "editor",
		"howPublished", "institution", "key", "month", "day", "note", "number", "organization",
		"pages", "publisher", "school", "series", "volume", "year",
		"isbn",
		"issn",
		// specimen
		"specimen", "standardImage", "imagesCount",
		"locality",
		"form",
		// Taxon
		"namespace",
		...
		"any",
		// user
		"uin", "pin", "userName", "email", "affiliation", "address", "lastName", "firstName",
		"suffix", "middleInit", "street1", "street2", "city", "country", "state", "zipcode",
		"userStatus", "privilegeTSN", "preferredServer", "preferredGroup", "userLogo", "logoUrl",
		// group
	...
	public String getHtmlItem(String field, String value) {
		if (value == null || value.length() < 1 || "unknown".equals(value)) return "";
		StringBuffer out = new StringBuffer();
		out.append("<b>").append(StringEscapeUtils.escapeHtml(field)).append(":</b> ").append(
				StringEscapeUtils.escapeHtml(value)).append("<br/>");
		return out.toString();
	}
