...
class NamespacePrefixMapperImpl extends NamespacePrefixMapper {
    ...
    public String getPreferredPrefix(String namespaceUri, String suggestion, boolean requirePrefix) {
        // I want the morphbank services namespace to be the default namespace.
//        if( "http://morphbank.net/schema/services".equals(namespaceUri) )
//            return "";
        // and the morphbank services namespace will use namespace.
        if( "http://www.morphbank.net/mbsvc3/".equals(namespaceUri) )
            return "mb";
        // and the dwcore namespace will use "dwc".
        if( "http://rs.tdwg.org/dwc/dwcore/".equals(namespaceUri) )
            return "dwc";
        // and the geospatial namespace will use "dwcg".
        if( "http://rs.tdwg.org/dwc/geospatial/".equals(namespaceUri) )
            return "dwcg";
        // and the curatorial namespace will use "dwc".
        if( "http://rs.tdwg.org/dwc/curatorial/".equals(namespaceUri) )
            return "dwcc";
        // and the curatorial namespace will use "dwc".
